...
@section('description')
{{__('words.descriptionabout')}}
@endsection

@section('keywords')
{{__('words.keywordsabout')}}
@endsection
...
@section('body')
  ...
  <div class="breadcrumb-option spad set-bg" data-setbg="{{asset('them/img/breadcrumb-bg.webp')}}">
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2>{{__('words.about_as')}}</h2>
                        <div class="breadcrumb__links">
                            <a href="/{{app()->getLocale()}}/">{{__('words.home')}}</a>
                            <span>{{__('words.about')}}</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="about__pic__item about__pic__item--large set-bg"
                                    data-setbg="{{asset('them/img/about/about-1.webp')}}"></div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="about__pic__item set-bg" data-setbg="{{asset('them/img/about/about-2.webp')}}"></div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="about__pic__item set-bg" data-setbg="{{asset('them/img/about/about-3.webp')}}"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="testimonial spad set-bg" data-setbg="{{asset('them/img/testimonial-bg.webp')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
