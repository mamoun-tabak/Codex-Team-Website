...
@section('body')
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <h3>{{ __('words.tc1') }}</h3>
                                <a href="{{__('words.linservices')}}" class="primary-btn">{{ __('words.go1') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="services__title">
                        ...
                        <p>{{__('words.ser_c')}}</p>
                        <a href="{{__('words.linservices')}}" class="primary-btn">{{__('words.go2')}}</a>
                    </div>
                </div>
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="services__item"><a href="{{__('words.lingallery')}}">
    ...
    <section class="work">
        <div class="work__gallery">
            ...
            <div class="work__item wide__item set-bg" data-setbg="{{asset('them/img/work/work-1.jpg')}}">
                ...
                <div class="work__item__hover">
                    <h4>Video Montage</h4>
                    <ul>
                        <a href="{{__('words.lingallery')}}"><li><i class="fa fa-external-link mr-2"></i>Our gallery</li></a> 
                     </ul>
                </div>
            </div>
            <div class="work__item small__item set-bg" data-setbg="{{asset('them/img/work/work-2.jpg')}}">
                <div class="work__item__hover">
                    <h4>Post Design</h4>
                    <ul>
                        <a href="{{__('words.lingallery')}}"><li><i class="fa fa-external-link mr-2"></i>Our gallery</li></a> 
            ...
            <div class="work__item small__item set-bg" data-setbg="{{asset('them/img/work/work-3.jpg')}}">
                <div class="work__item__hover">
                    <h4>Advertisement</h4>
                    <ul>
                        <a href="{{__('words.lingallery')}}"><li><i class="fa fa-external-link mr-2"></i>Our gallery</li></a> 
            ...
            <div class="work__item large__item set-bg" data-setbg="{{asset('them/img/work/work-4.jpg')}}">
                <div class="work__item__hover">
            ...
            <div class="work__item small__item set-bg" data-setbg="{{asset('them/img/work/work-5.jpg')}}">
            ...
            <div class="work__item small__item set-bg" data-setbg="{{asset('them/img/work/work-6.jpg')}}">
            ...
            <div class="work__item wide__item set-bg" data-setbg="{{asset('them/img/work/work-7.jpg')}}">
                <div class="work__item__hover">
    ...
    <section class="team spad set-bg" data-setbg="{{asset('them/img/team-bg.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 p-0">
                    <div class="team__item set-bg" data-setbg="{{asset('them/img/team/team-1.jpg')}}">
                        <div class="team__item__text">
                            <h4>{{__('words.tw4')}}</h4>
                            <p>{{__('words.live')}}</p>
                            <div class="team__item__social">
                                <a href="{{route('demo.company')}}" title="View"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 p-0">
                    <div class="team__item team__item--second set-bg" data-setbg="{{asset('them/img/team/team-2.jpg')}}">
                        <div class="team__item__text">
                            <h4>{{__('words.tw3')}}</h4>
                            <p>{{__('words.live')}}</p>
                            <div class="team__item__social">
                                <a href="{{route('demo.store')}}" title="View"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 p-0">
                    <div class="team__item team__item--third set-bg" data-setbg="{{asset('them/img/team/team-3.jpg')}}">
                        <div class="team__item__text">
                            <h4>{{__('words.tw2')}}</h4>
                            <p>{{__('words.live')}}</p>
                            <div class="team__item__social">
                                <a href="{{route('demo.resturant')}}" title="View"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6 p-0">
                    <div class="team__item team__item--four set-bg" data-setbg="{{asset('them/img/team/team-4.jpg')}}">
                        <div class="team__item__text">
                            <h4>{{__('words.tw1')}}</h4>
                            <p>{{__('words.live')}}</p>
                            <div class="team__item__social">
                                <a href="{{route('demo.personal')}}" title="View"><i class="fa fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12 p-0">
                    <div class="team__btn">
                        <a href="{{__('words.lindemo')}}" class="primary-btn">{{__('words.next')}}</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="callto__text">
                        <h2>Start your success story with us.{{__('words.')}}</h2>
                        <p>Do not hesitate to contact us{{__('words.')}}</p>
                        <a href="https://wa.me/966561747859">Start your project{{__('words.')}}</a>
                    </div>
                </div>
            </div>
        </div>
